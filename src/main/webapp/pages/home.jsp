    ...
    <div class="container-fluid">
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="https://www.sql-ex.ru/help/select13.php#db_1" class="btn btn-dark">Краткая информация о базе данных "Компьютерная фирма"</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5 class="card-title">Задание: <%= request.getAttribute("number") %>  (<%= request.getAttribute("score") %>)</h5>
                                            ...
                                            <hr class="my-4">
                                            <p>Справка по теме:</p>
                                            <a href="http://www.sql-tutorial.ru/ru/book_simple_select_statement/page1.html" class="btn btn-dark">Простой оператор Select</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group mb-3">
                                <label for="exampleTextarea">Enter SQL script</label>
                                <textarea class="form-control" id="exampleTextarea" rows="5" name="sqlScript"></textarea>
                            </div>
                ...
                <div class="d-grid gap-2 col-3 mx-auto mb-3">
                    <a class="btn btn-dark" href="/rightCode" role="button">Get right code</a>
                </div>

                <div class="container mt-5">
                    <% if (request.getAttribute("rightCode") != null) { %>
                    <div>
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Код правильный, ты молодец</h5>
                                    <p class="card-text"> <%= request.getAttribute("rightCode") %></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Хватит гавнокодить !!!</h5>
                                    <p class="card-text"> <%= request.getAttribute("wrongCode") %> </p>
                                </div>
                            </div>
                        </div>
                    </div>
